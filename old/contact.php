	...
	<div class='center_col' style='min-height: 225px;'>
		<div class='kolom' style='width: 600px;margin-top: 25px;'>
			...
			<div class='kolom-content'>
				<form action="mailto:corsec@victoriainvestama.co.id" method="post" enctype="text/plain">
		...
		<div class='kolom' style='width: 275px;'>
			<div class='kolom-content'>
				...
				<div style='margin-bottom: 2px;padding: 7px;font: 11px arial;'>
					...
					<a style='font-weight: normal;color: #1A5BFF;text-decoration: none;' href="mailto:corsec@victoriainvestama.co.id">corsec@victoriainvestama.co.id</a>
				</div>
			</div>
		</div>
	</div>
