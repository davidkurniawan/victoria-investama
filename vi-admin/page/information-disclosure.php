    ...
    <div class="col-lg-12">
        <section class="panel">
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <div class="panel-body">
                                <a href=?page=new-id class="btn btn-success">Add new</a>
                        </div>
                    </section>
            ...
            <table class="table table-striped table-advance table-hover">
                ...
                <tbody>
                  <?php
                  include "controller/information-disclosure.php";
                  $id_modal=0;
                  while($ListFile=mysql_fetch_object($content_file))
                  {
                    ...
                    */
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="index.php?page=edit-id&id=<?=$ListFile->id;?>" class="btn btn-primary btn-xs">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="controller/delete-id-lo.php?id=<?=$ListFile->id;?>" class="btn btn-warning">Confirm</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
