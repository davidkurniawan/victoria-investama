    ...
    <div class="col-lg-12">
        <section class="panel">
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <div class="panel-body">
                                <a href=?page=new-milestone class="btn btn-success">Add new</a>
                        </div>
                    </section>
            ...
            <table class="table table-striped table-advance table-hover">
                ...
                <tbody>
                  <?php
                  include "controller/milestone.php";
                  $id_modal=0;
                  while($list=mysql_fetch_object($content))
                  {
                    ...
                    */
                    ...
                    <tr>
                        ...
                        <td><a href="#"><?=$list->Year;?></a></td>
                        <td class="hidden-phone"><?=$list->InformationEN;?></td>
                        <td>
                            <a href="index.php?page=edit-milestone&id=<?=$list->id;?>" class="btn btn-primary btn-xs">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="controller/delete-milestone-lo.php?id=<?=$list->id;?>" class="btn btn-warning">Confirm</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
