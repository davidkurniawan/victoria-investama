    ...
    <div class="col-lg-12">
      <section class="panel">
          ...
          <div class="panel-body">
            <div class="panel-body">
                  <form class="form-horizontal tasi-form" method="post" action="controller/save-ar-lo.php" enctype="multipart/form-data">
                    <div class="form-group">
                                          ...
                                          <div class="form-group">
                                              ...
                                              <div class="col-sm-3">
                                                  <input type="file" Name="ar-file" class="form-control default" value="">
                                              </div>
                                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                                  <input type="text" Name="annual_report_year" class="form-control" value="">
                              </div>
                          </div>
            </div>
                  ...
                  <div id="indonesia" class="tab-pane active">
                    <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" Name="annual_report_info_id" class="form-control" value="">
                                </div>
                            </div><br>
                    </div>
                  </div>
                  <div id="english" class="tab-pane" >
                    <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" Name="annual_report_info_en" class="form-control" value="">
                                                </div>
                                            </div>
                    </div>
                  </div>
