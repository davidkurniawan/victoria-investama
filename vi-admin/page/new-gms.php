    ...
    <div class="col-lg-12">
      <section class="panel">
          <header class="panel-heading">
             New General Meeting Of shareholder
          </header>
          <div class="panel-body">
            <div class="panel-body">
                  <form class="form-horizontal tasi-form" method="post" action="controller/save-gms-lo.php" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                                  <input type="text" Name="gms-year" class="form-control" value="">
                              </div>
                          </div>
            </div>
                  ...
                  <div id="indonesia" class="tab-pane active">
                    <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" Name="gms_info_id" class="form-control" value="">
                                </div>
                            </div><br>
                    </div>
                  </div>
                  <div id="english" class="tab-pane" >
                    <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" Name="gms_info_en" class="form-control" value="">
                                                </div>
                                            </div>
                    </div>
                  </div>
