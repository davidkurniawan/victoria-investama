    ...
    <div class="col-lg-12">
        <section class="panel">
            <header class="panel-heading">
                Events Presentation File Manager
            </header>
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        <div class="panel-body">
                                <a href=?page=new-ep class="btn btn-success">Add new</a>
                        </div>
                    </section>
            ...
            <table class="table table-striped table-advance table-hover">
                ...
                <tbody>
                  <?php
                  include "controller/events-presentation.php";
                  $id_modal=0;
                    ...
                    */
                    ...
                    <tr>
                      ...
                      <td class="hidden-phone"><img src='<?=$ListFile->CoverImg;?>' width=100px></td>
                        ...
                        <td>
                            <a href="index.php?page=edit-ep&id=<?=$ListFile->id;?>" class="btn btn-primary btn-xs">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="controller/delete-ep-lo.php?id=<?=$ListFile->id;?>" class="btn btn-warning">Confirm</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
