        ...
        <section class="panel">
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <div class="panel-body">
                                <a href=?page=post-news class="btn btn-success">Post News</a>
                        </div>
                    </section>
            ...
            <table class="table table-striped table-advance table-hover">
                ...
                <tbody>
                  ...
                  $con = new DB_con();
                  $news=$con->select_order('news','date_created','desc');
                  $id_modal=0;
                  while($list_news=mysql_fetch_object($news))
                  {
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="index.php?page=edit-news&news_id=<?=$list_news->id;?>" class="btn btn-primary btn-xs">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="controller/delete-news-lo.php?news_id=<?=$list_news->id;?>" class="btn btn-warning">Confirm</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
