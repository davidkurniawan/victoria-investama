...
$bod_id=$_REQUEST['bod_id'];
$con = new DB_con();
$bod=$con->select_where("bod","id",$bod_id);
$selected_bod=mysql_fetch_object($bod);
 ?>
<div class="row">
    <div class="col-lg-12">
      <section class="panel">
          ...
          <div class="panel-body">
              ...
              <div class="tab-content">
                  <div id="indonesia" class="tab-pane active">
                    <div class="panel-body">
                      <form action="controller/update-bod-lo.php" enctype="multipart/form-data" method="post">
