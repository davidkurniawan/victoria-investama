    ...
    <div class="col-lg-12">
        <section class="panel">
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <div class="panel-body">
                                <a href=?page=page-editor class="btn btn-success">Create New Page</a>
                        </div>
                    </section>
            ...
            <table class="table table-striped table-advance table-hover">
                ...
                <tbody>
                  <?php
                  include "controller/page-manager-lo.php";
                  $id_modal=0;
                  while($ListPage=mysql_fetch_object($data_page))
                  {
                    ...
                    <tr>
                        ...
                        <td class="hidden-phone"><?=$PageName->MenuName;?></td>
                          <td class="hidden-phone"><?=$ListPage->Title_en;?></td>
                        <td>
                            <a href="index.php?page=edit-page&page_id=<?=$ListPage->id;?>&menu_id=<?=$PageName->id;?>" class="btn btn-primary btn-xs">
